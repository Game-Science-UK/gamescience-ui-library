...
Installed library version: **1.1.0**
...
```text
https://game-science-uk.github.io/gamescience-ui-library/versions/1.1.0/r/{name}.json
```

- Agent catalogue:

```text
https://game-science-uk.github.io/gamescience-ui-library/versions/1.1.0/agent-catalogue.json
```
