...
Installed library version: **1.2.1**
...
```text
https://game-science-uk.github.io/gamescience-ui-library/versions/1.2.1/r/{name}.json
```

- Agent catalogue:

```text
https://game-science-uk.github.io/gamescience-ui-library/versions/1.2.1/agent-catalogue.json
```
