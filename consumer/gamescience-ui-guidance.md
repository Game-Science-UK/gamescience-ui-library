...
Installed library version: **1.2.2**
...
```text
https://game-science-uk.github.io/gamescience-ui-library/versions/1.2.2/r/{name}.json
```

- Agent catalogue:

```text
https://game-science-uk.github.io/gamescience-ui-library/versions/1.2.2/agent-catalogue.json
```
