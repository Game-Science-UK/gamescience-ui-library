...
```text
https://game-science-uk.github.io/gamescience-ui-library/versions/0.5.1/r/{name}.json
```
...
```json
{
  ...
  "registries": {
    "@gamescience": "https://game-science-uk.github.io/gamescience-ui-library/versions/0.5.1/r/{name}.json"
  }
}
```
...
- GameScience UI version: `0.5.1`
- Active test theme: `gamescience` (switch only via GameScienceProvider; do not mix themes)
- Registry namespace: `@gamescience`
- Versioned registry URL: https://game-science-uk.github.io/gamescience-ui-library/versions/0.5.1/r/{name}.json
- Local installed source under `src/` is authoritative for implementation
- Catalogue: https://game-science-uk.github.io/gamescience-ui-library/versions/0.5.1/agent-catalogue.json
