...
export interface RegistryItemDefinition {
  ...
  catalogue: {
    ...
    themes: Array<"gamescience" | "citadel" | "sentinel">;
    related?: string[];
    props?: string[];
    family?:
      | "foundations"
...
export const registryItems: RegistryItemDefinition[] = [
  ...
  },
  {
    ...
    catalogue: {
      ...
      contexts: ["all"],
      themes: ["gamescience"],
      related: ["theme-citadel", "theme-sentinel"],
    },
  },
  {
    name: "theme-citadel",
    ...
    catalogue: {
      ...
      contexts: ["all"],
      themes: ["citadel"],
      related: ["theme-gamescience", "theme-sentinel"],
    },
  },
  {
    name: "theme-sentinel",
    ...
    description:
      "Sentinel void theme CSS with cinematic (default) and restrained registers — no component forks. Font stacks only; load fonts at the application level (see docs/font-loading.md).",
    category: "theme",
    registryDependencies: ["base"],
    files: [
    ...
    catalogue: {
      ...
      avoid: [
        ...
        "installing alongside theme-gamescience or theme-citadel as concurrent nested themes",
        "reproducing application-owned globe, rain, radar, or boot choreography",
      ],
      contexts: ["all"],
      themes: ["sentinel"],
