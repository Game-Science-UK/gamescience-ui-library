  ...
  writeFileSync(
    ...
    `export default { content: ["./index.html","./src/**/*.{ts,tsx}"], theme: { extend: {
      colors: {
        ...
        primary: { DEFAULT: "oklch(var(--primary) / <alpha-value>)", hover: "oklch(var(--primary-hover) / <alpha-value>)", active: "oklch(var(--primary-active) / <alpha-value>)", foreground: "oklch(var(--primary-foreground) / <alpha-value>)" },
        secondary: { DEFAULT: "oklch(var(--secondary) / <alpha-value>)", hover: "oklch(var(--secondary-hover) / <alpha-value>)", active: "oklch(var(--secondary-active) / <alpha-value>)", foreground: "oklch(var(--secondary-foreground) / <alpha-value>)" },
