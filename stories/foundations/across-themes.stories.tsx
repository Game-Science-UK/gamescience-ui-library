...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Compare GameScience and Citadel via the toolbar Theme control. Only one theme is active at the application root. Production apps should install and use a single theme.",
      },
    },
  },
} satisfies Meta;
